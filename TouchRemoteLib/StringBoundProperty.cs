...
namespace TouchRemote.Lib
{
    ...
    /// </remarks>
    public interface StringBoundProperty : IBoundProperty<string> { }

    /// <summary>
    /// Represents a dynamic (provided by a BoundPropertyProvider) bound property
    /// </summary>
    public interface ProvidedStringBoundProperty : StringBoundProperty, IProvided { }
    ...
    /// </remarks>
    public interface StringBoundPropertyProvider : IProvider<ProvidedStringBoundProperty> { }
}
